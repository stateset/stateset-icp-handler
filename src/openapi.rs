...
#[openapi(
    ...
    paths(
        crate::handlers::ops::health,
        crate::handlers::ops::ready,
        crate::handlers::ops::metrics_handler,
        crate::handlers::discovery::discovery_handler,
        crate::handlers::discovery::jwks_handler,
        crate::handlers::intents::submit_intent,
        crate::handlers::queries::list_transactions,
        crate::handlers::queries::get_transaction,
        crate::handlers::queries::list_subscriptions,
        crate::handlers::queries::get_subscription,
        crate::handlers::queries::list_peer_quotes,
        crate::handlers::queries::get_peer_quote,
        crate::handlers::webhook_admin::list_webhook_deliveries,
        crate::handlers::webhook_admin::get_webhook_delivery,
        crate::handlers::webhook_admin::retry_webhook_delivery,
        crate::handlers::webhook_admin::create_webhook_subscriber,
        crate::handlers::webhook_admin::list_webhook_subscribers,
        crate::handlers::webhook_admin::get_webhook_subscriber,
        crate::handlers::webhook_admin::update_webhook_subscriber,
        crate::handlers::webhook_admin::disable_webhook_subscriber,
        crate::handlers::webhook_admin::enable_webhook_subscriber,
        crate::handlers::webhook_admin::delete_webhook_subscriber,
        crate::handlers::queries::list_receipts,
        crate::handlers::queries::get_receipt,
        crate::handlers::queries::get_mandate_usage,
        crate::handlers::events::sse_events,
    ),
    components(schemas(
        ...
        crate::handlers::webhook_admin::CreateSubscriberBody,
        crate::handlers::webhook_admin::UpdateSubscriberBody,
    )),
    tags(
